      ...
      <>
        ...
        <main>
          ...
          <div className="flex flex-col items-center justify-center gap-5 mt-16">
              <h2 className="text-5xl text-baby-blue font-schoolbell">Our Mission</h2>
          ...
          {/* Our Philosophy */}
          <div className="flex flex-col items-center justify-center gap-5 mt-16">
              <h2 className="text-5xl text-baby-blue font-schoolbell">Our Philosophy</h2>
          ...
          {/* Our Environment */}
          <div className="flex flex-col items-center justify-center gap-5 mt-16">
              <h2 className="text-5xl text-baby-blue font-schoolbell">Our Environment</h2>
              <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-10">
                  <div className="flex flex-col gap-4 max-w-[80%] md:max-w-[50%]">
                      <p className="text-sm text-justify">
          ...
          <div className="flex flex-col items-center justify-center gap-5 mt-16 mb-16">
              <h2 className="text-5xl text-baby-blue font-schoolbell">Our Team</h2>
              <div className="flex flex-col md:flex-row items-center justify-center gap-10">
