    ...
    return (
        <main>
            ...
            <div className="flex flex-col items-center justify-center gap-10 m-10 mb-20">
                <h2 className="text-5xl font-schoolbell text-baby-blue text-center">Request an Enrollment</h2>
                ...
                <button onClick={openModal} className="bg-baby-blue text-white px-4 py-2 rounded-md font-schoolbell">SCHEDULE A TOUR</button>
            </div>

            <div className="flex flex-col items-center justify-center gap-10 m-5 mb-20">
                <h2 className="text-5xl font-schoolbell text-baby-blue text-center">Offer</h2>
            ...
            <div className="flex flex-col items-center justify-center gap-10 m-5 mb-20">
                <h2 className="text-5xl font-schoolbell text-baby-blue text-center">Fee</h2>
                <p className="text-sm text-black text-justify max-w-[600px]">
